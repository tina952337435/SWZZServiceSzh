...
public interface St_stbprp_b_sttpData {
    ...
    List<St_stbprp_b_sttpPojo> selectList(@Param(value = "ID") String ID, @Param(value = "key") String key,
                                          @Param(value = "stime") String stime, @Param(value = "etime") String etime,
                                          @Param(value = "type")List<String> type,
                                          @Param(value = "startindex") Integer startindex, @Param(value = "pagesize") Integer pagesize);

    Integer updateOne(St_stbprp_b_sttpPojo St_stbprp_b_qu_treePojo);

    Integer insertOne(St_stbprp_b_sttpPojo St_stbprp_b_qu_treePojo);
