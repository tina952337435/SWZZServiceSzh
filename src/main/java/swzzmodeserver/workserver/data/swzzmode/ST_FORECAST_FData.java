...
public interface ST_FORECAST_FData {
        ...
        List<ST_FORECAST_FPojo> selectListFast(
                        @Param(value = "UNITNAME") List<String> UNITNAME,
        ...
        Integer deleteOne(@Param(value = "ID") String ID, @Param(value = "UNITNAME") String UNITNAME,
                        @Param(value = "FYMDH") String FYMDH, @Param(value = "IYMDH") String IYMDH,
                        @Param(value = "YMDH") String YMDH);
        ...
        Integer deleteByFymdh(@Param(value = "FYMDH") String FYMDH);
}
