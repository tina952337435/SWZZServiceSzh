...
@Mapper
public interface Tz_gridData {

    List<Tz_gridPojo> selectList(@Param(value = "ID") String ID, @Param(value = "key") String key,
                                 @Param(value = "stime") String stime, @Param(value = "etime") String etime,
                                 @Param(value = "type")List<String> type,
                                 @Param(value = "startindex") Integer startindex,@Param(value = "pagesize") Integer pagesize);

    Integer updateOne(Tz_gridPojo bdmsPredictPojo);

    Integer insertOne(Tz_gridPojo bdmsPredictPojo);
