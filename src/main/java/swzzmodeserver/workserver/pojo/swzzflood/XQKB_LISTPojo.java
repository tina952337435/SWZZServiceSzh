...
public class XQKB_LISTPojo {
    ...
    @JsonProperty("XQKB_JIAOHE")
    private String XQKB_JIAOHE; // 校核人
    @JsonProperty("XQKB_JIAOHETM")
    private String XQKB_JIAOHETM; // 校核时间

    @JsonProperty("XQKB_CHECK_STATUS")
    private String XQKB_CHECK_STATUS; // 校核状态
}