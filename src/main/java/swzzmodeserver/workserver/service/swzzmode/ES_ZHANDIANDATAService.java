...
public interface ES_ZHANDIANDATAService {
        ...
        Integer TideLineardifference(String solutionid, List<ES_ZHANDIANDATAPojo> list, String stcd, String type,
                        String startDate, String endDate);

        Integer TideLineardifferenceXG(String solutionid, List<ES_ZHANDIANDATAPojo> list, String stcd, String type,
                        String startDate, String endDate);

        Integer ModifyGCSSLLAREAGCGZ(String solutionid, List<String> zhanid, List<String> yanid);

        Integer FH_inset_ModifyApi(String bdms_predictSqlStr, DD_SOLUTIONPojo ddobj, Boolean isGetCookieDD_ID,
                        String solutionid);
        ...
        List<Map<String, Object>> YBSHUIWEI(String stime, String etime, String stcd, String plan_n, String type,
        ...
        List<ST_TIDEHIGHParam> SWZZ_FLOODTIDEDATA_ST_TIDEHIGH_RSel(String stcd, String stime, String etime,
                        String tdptn);
